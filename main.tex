...
\ifpdf
\pdfinfo{
   /Author (Daniel Francisco Tapia Rybertt)
   /Title ( Ingeniería Inversa de Aplicaciones Móviles para Descubrimiento
             de Vulnerabilidades: Amenazas y Defensas)
   /Keywords (Android;Smali;Java;Apktool)
...
\usepackage{textcomp}                  %Trademark or TS1 symbols
% \usepackage{dirtree}                   %Directory Tree Listings
% \usepackage{forest}                 %Directory Tree Listings Pretty
\usepackage{tikz}
\usepackage{minted}
...
every listing line={\textcolor{red}{\small\ttfamily\bfseries danielftapiar \$> }}}
